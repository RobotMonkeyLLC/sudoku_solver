...
export default function Board({board}) {
    return (
        ...
        <div className="bg-warning p-md-1 p-lg-2 row d-flex flex-wrap justify-content-center col-md-12 col-lg-8">
            {
                /* [...Array(9+2)].map((_, i) => (
                    i === 3 || i === 7 ? 
                ...
                board.map((group, i) => (
                    <div key={i} className="col-4 d-flex flex-wrap justify-content-center px-0 my-1">
                        <CellGroup group={group}></CellGroup>
                    </div>
                ))
            }
